...
difference(){
    ...
    //make a cut between the top and bottom
    translate([0,0,0.05]){
        difference(){
            cube([30,30,0.1],center = true);
...
difference(){
    ...
    //stem mould for the inside
    translate([0,0,-2.5]){
        cherry_stem();
    }
    //resin outlet holes
    translate([7.5,7.5,-1.95]){
        cylinder(2,1,1);
    }
    translate([7.5,-7.5,-1.95]){
        cylinder(2,1,1);
    ...
    translate([0,-8.1,-1.95]){
        cylinder(2,1,1);
    }
    translate([0,8.1,-1.95]){
        cylinder(2,1,1);
    }
    translate([-8.1,0,-1.95]){
        cylinder(2,1,1);
    }
    translate([8.1,0,-1.95]){
        cylinder(2,1,1);
